...
#         url = self._with_rtsp_transport(self.url)
...
#     def _with_rtsp_transport(self, url: str) -> str:
#         if not self.rtsp_transport:
#             return url
#         if not url.lower().startswith("rtsp://"):
#             return url
#         parts = urlsplit(url)
#         query = dict(parse_qsl(parts.query, keep_blank_values=True))
#         if "rtsp_transport" in query:
#             return url
#         query["rtsp_transport"] = self.rtsp_transport
